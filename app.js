...
const maxOfTwoNumbers = (x, y) => { if (x >= y) { return x; } else { return y; } }
...
const isAdult = (age) => { if (age >= 18) { return 'Adult'; } else { return 'Minor'; } }
...
Complete the exercise in the space below: */ const isCharAVowel = (char) => {

const aVowel = ('a', 'e', 'i', 'o', 'u') 
if (char = 'a') return true; if (char = 'e') return true; if (char = 'i') return true; if (char = 'o') return true;
...
function generateEmail (name, domain) { return name + "@" + domain
...
function greetUser (name, timeOfDay) { const greeting = name + timeOfDay (greeting1, greeting2, greeting3) let greeting1 = ('name, good morning') let greeting2 = ('name, good afternoon') let greeting3 = ('name, good evening')

} return greeting1, greeting2, greeting3 function greetUser(name, timeOfDay) { let greeting; if (timeOfDay === 'morning') { greeting = 'Good morning, ' + name; } else if (timeOfDay === 'afternoon') { greeting = 'Good afternoon, ' + name; } else if (timeOfDay === 'evening') { greeting = 'Good evening, ' + name; } else { // A default case for any other time greeting = 'Hello, ' + name; }
...
Complete the exercise in the space below: */ function maxOfThree(x, y, z) { if (x >= y && x >= z) { return x; } else if (y >= x && y >= z) { return y; } else { return z; } }
...
function calculateTip (billAmount, tipPercentage) { const tip = billAmount * (tipPercentage / 20); return tip; }
...
Example: convertTemperature(32, 'C') should return 89.6 (Fahrenheit). Example: convertTemperature(32, 'F') should return 0 (Celsius).

Complete the exercise in the space below: */ function convertTemperature (temperature, scale) {
...
Complete the exercise in the space below: */ function basicCalculator (num1, num2, operation) { if (operation === 'add') { return num1 + num2; } else if (operation === 'subtract') { return num1 - num2; } else if (operation === 'multiply') { return num1 * num2; } else if (operation === 'divide') { return num1 / num2; } else { return 'Invalid operation'; } }
